...
public class GaussianEliminationStructureTest {
    ...
    public static void init() {
        CheckThat.theClass("GaussianElimination")
    ...
    public void methodCheckMatrixDimensions() {
        it.hasMethodWithParams("setMatrix", "array of array of double")
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL)
            .thatReturnsNothing();
    }
    ...
    public void methodPrint() {
        it.hasMethodWithNoParams("printEquations")
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL)
            .thatReturnsNothing();
    }
